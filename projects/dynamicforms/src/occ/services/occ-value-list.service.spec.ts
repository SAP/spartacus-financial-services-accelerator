...
describe('OccValueListService', () => {
  ...
  describe('OccValueListService', () => {
    it('should get values from value list API call', async(() => {
  ...
  describe('OccValueListService', () => {
    it('should get values from external API', async(() => {
  ...
  describe('OccValueListService', () => {
    it('should get values from value list API call with parent item', async(() => {
      occValueListService
