...
export class FormDataEffects {
  loadFormData$: Observable<any> = createEffect(() =>
    this.actions$.pipe(
      ...
      mergeMap(payload => {
        return this.formConnector
          ...
          .pipe(
            ...
            catchError(error => {
              return of(
                new fromActions.LoadFormDataFail(JSON.stringify(error))
              );
            })
          );
      })
  ...
  saveFormData$: Observable<any> = createEffect(() =>
    this.actions$.pipe(
      ...
      mergeMap(payload => {
        return this.formConnector
          ...
          .pipe(
            ...
            catchError(error => {
              return of(
                new fromActions.SaveFormDataFail(JSON.stringify(error))
              );
            })
          );
      })
