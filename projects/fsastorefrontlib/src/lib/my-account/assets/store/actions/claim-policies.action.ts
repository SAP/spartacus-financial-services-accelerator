...
export const LOAD_CLAIM_POLICIES_SUCCESS = '[ClaimPolicies] Load Claim-Policies Success';
export const LOAD_CLAIM_POLICIES_FAIL = '[ClaimPolicies] Load Claim-Policies Fail';
