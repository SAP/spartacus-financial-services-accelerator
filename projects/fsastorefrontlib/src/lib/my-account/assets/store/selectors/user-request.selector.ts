...
export const getUserRequestRefresh: MemoizedSelector<any, boolean> = createSelector(
  getUserRequestState,
  fromUserRequest.getRefresh
);

export const getUserRequestLoaded: MemoizedSelector<any, boolean> = createSelector(
  getUserRequestState,
