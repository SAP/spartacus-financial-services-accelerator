...
export const SET_IDENTIFICATION_TYPE_SUCCESS = '[Cart] Set Identification Type Success';
export const SET_IDENTIFICATION_TYPE_FAIL = '[Cart] Set Identification Type Fail';
