export const claim = {
  claim: {
    ...
    confirmation: {
      ...
      submissionNotice:
        'Ihr Schadensfall wurde erfolgreich in unserem System gespeichert.',
      submissionStatus:
        'Sie finden die Bestätigungs-E-Mail im Posteingang Ihres Self-Service-Portals und in Ihrem Postfach.',
      questionsOrConcerns:
