...
import { FSOrderOverviewComponent } from './order-overview.component';
...
describe('FSOrderOverviewComponent', () => {
  let component: FSOrderOverviewComponent;
  let fixture: ComponentFixture<FSOrderOverviewComponent>;
  let translationService: TranslationService;

  beforeEach(async(() => {
    TestBed.configureTestingModule({
      imports: [I18nTestingModule],
      declarations: [FSOrderOverviewComponent, MockCardComponent],
      providers: [
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(FSOrderOverviewComponent);
