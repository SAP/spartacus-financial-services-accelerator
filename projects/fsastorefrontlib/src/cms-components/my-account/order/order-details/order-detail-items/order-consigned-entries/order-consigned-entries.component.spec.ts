...
import { FSOrderConsignedEntriesComponent } from './order-consigned-entries.component';
...
describe('FSOrderConsignedEntriesComponent', () => {
  let component: FSOrderConsignedEntriesComponent;
  let fixture: ComponentFixture<FSOrderConsignedEntriesComponent>;
  let el: DebugElement;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(FSOrderConsignedEntriesComponent);
