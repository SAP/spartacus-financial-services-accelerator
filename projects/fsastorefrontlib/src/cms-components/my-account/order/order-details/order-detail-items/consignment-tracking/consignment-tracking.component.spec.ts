...
import { of } from 'rxjs';
import { FSConsignmentTrackingComponent } from './consignment-tracking.component';
...
describe('FSConsignmentTrackingComponent', () => {
  let component: FSConsignmentTrackingComponent;
  let fixture: ComponentFixture<FSConsignmentTrackingComponent>;
  let el: DebugElement;
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [FSConsignmentTrackingComponent, MockTranslateUrlPipe],
      providers: [
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(FSConsignmentTrackingComponent);
