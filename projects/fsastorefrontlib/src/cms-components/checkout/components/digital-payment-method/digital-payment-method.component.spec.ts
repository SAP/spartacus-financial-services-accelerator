...
import { FSDigitalPaymentMethodComponent } from './digital-payment-method.component';
...
describe('FSDigitalPaymentMethodComponent', () => {
  let component: FSDigitalPaymentMethodComponent;
  let fixture: ComponentFixture<FSDigitalPaymentMethodComponent>;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(FSDigitalPaymentMethodComponent);
