...
context ('ProductCategoryPage', () => {
  ...
  it('should check homeowners product category page', ()=> {
    cy.selectOptionFromDropdown({menuOption: 'Insurance',dropdownItem: 'Homeowners'});
    productCategory.checkComponets();
    productCategory.insuranceRetreiveButton();
    ...
    cy.get('h3.section-header-heading').should('contain', 'Homeowners Annually');
    cy.get('ul.item-details').should('have.length', 2);
  })

  it('should check renters product category page', ()=> {
    cy.selectOptionFromDropdown({menuOption: 'Insurance',dropdownItem: 'Renters'});
    productCategory.checkComponets();
    productCategory.insuranceRetreiveButton();
    cy.get('div.product-feature-wrapper').should('have.length', 2);
  ...
  it('should check Auto product category page', ()=> {
    cy.selectOptionFromDropdown({menuOption: 'Insurance',dropdownItem: 'Auto'});
    productCategory.checkComponets();
    productCategory.insuranceRetreiveButton();
  ...
  it('should check Life product category page', ()=> {
    cy.selectOptionFromDropdown({menuOption: 'Insurance',dropdownItem: 'Life'});
    productCategory.checkComponets();
    productCategory.insuranceRetreiveButton();
    cy.get('div.product-feature-wrapper').should('have.length', 2);
  ...
  it('should check Travel product category page', ()=> {
    cy.selectOptionFromDropdown({menuOption: 'Insurance',dropdownItem: 'Travel'});
    productCategory.checkComponets();
    productCategory.insuranceRetreiveButton();
    cy.get('div.product-feature-wrapper').should('have.length', 3);
  ...
  it('should check Event product category page', ()=> {
    cy.selectOptionFromDropdown({menuOption: 'Insurance',dropdownItem: 'Event'});
    productCategory.checkComponets();
    productCategory.insuranceRetreiveButton();
    cy.get('div.product-feature-wrapper').should('have.length', 3);
  ...
  it('should check Savings product category page', ()=> {
    cy.selectOptionFromDropdown({menuOption: 'Insurance',dropdownItem: 'Savings'});
    productCategory.checkComponets();
    productCategory.insuranceRetreiveButton();
    cy.get('div.product-feature-wrapper').should('have.length', 3);
  ...
  it('should check Current Account product category page', ()=> {
    ...
    productCategory.checkComponets();
    productCategory.bankingRetreiveApplication();
    cy.get('div.product-feature-wrapper').should('have.length', 3);
